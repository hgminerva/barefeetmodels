...
<html lang="en">
<head>
    <title>Code coverage report for controls/vg-scrub-bar/vg-scrub-bar-current-time/</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> controls/vg-scrub-bar/vg-scrub-bar-current-time/
    </h1>
    <div class='clearfix'>
...
<tbody><tr>
	<td class="file medium" data-value="vg-scrub-bar-current-time.ts"><a href="vg-scrub-bar-current-time.ts.html">vg-scrub-bar-current-time.ts</a></td>
