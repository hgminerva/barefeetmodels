...
<html lang="en">
<head>
    <title>Code coverage report for core/vg-player/vg-player.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">core/vg-player/</a> vg-player.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ngAfterContentInit() {
        this.medias.toArray().forEach(<span class="fstat-no" title="function not covered" >(media)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >            this.api.registerMedia(media);</span>
        });
&nbsp;
